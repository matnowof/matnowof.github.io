	...
	<div class="uk-offcanvas-bar spaco">		
    	<ul class="uk-list branco ">
			...
			<li>
    		    ...
    		    <div>
                	<ul>
                     	<li id="textmenu7" style="display:none;"><a onclick="UIkit.offcanvas.hide();mudatema1('black1');mudatema2('black2');mudatema3('black1');mudaicon('pergunta');mudatema1('black3');mudatema1('black4');mudatema1('black5');mudatema2('popup');mudatema2('popup2');" >Mudar Tema</a>               
    				</ul>
    			</div>
			</li>
			<li>
    ...
    <div class="uk-form uk-form-stacked"  id="frm" style="margin-top:20px" method="POST" action="" onsubmit="javascript:if(valida()==false) event.preventDefault();">
        <div class="uk-grid">
            <div class="uk-width-1-1">
            	<label class="uk-form-label" >Escreva a Equação a ser calculada: <a href="#popup02"> <svg  width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="float:right;width:20px;"><a href="#popup1"> </a>
...
<div id="popup02" class="overlay">
	<div id="popup2" class="popup">
		<h2>Escreva as suas ou use da comunidade</h2>
		<a class="close" href="#">×</a>
<br>
<table style="width:100%;text-align:left;margin-top:10px" ><tbody>
<h4>Escreva as suas funções</h4>
<tr>
      <th>Sigla</th>
      <th>Nome</th>
      <th>Como escrever</th>
...
<td> <input name="Sigla" id="Sigla" type="text" class="cemp" style="width:90%" placeholder="FMBK " onblur="atzarrayf();verifnfunc(this)" onkeypress="alphanum(event)" required> </td>
<td> <input name="Nome" id="Nome" type="text" class="cemp" style="width:90%" placeholder="Bhaskara" onblur="atzarrayf()required" required> </td> 
<td> <input name="Como_Escrever" id="Como_Escrever" type="text" class="cemp" style="width:90%" placeholder="(-b+raiz(b^2-4*a*c))/(2*a)" onblur="atzarrayf();verifnfunc(this)" onkeypress="alphanum(event)" required> </td>
<td> <input name="Descricao" id="Descricao" type="text" class="cemp" style="width:90%" placeholder="Fórmula de Bhaskara" onblur="atzarrayf();verifnfunc(this)" onkeypress="alphanum(event)" required> </td> 
<input type="submit" style="cursor:pointer;width:60px" id="submit" name="submit" title="Salvar" Salvar> 
   </form>
</table>
<br>
<!--<td onclick="apagafunpg(this.parentNode)" style="cursor:pointer;width:20px" title="Apagar">!-->


<h4>Busque funções de outros usuários</h4>
  ...
  <table class="tabela" id="myMenu">
   <tbody class="tabelhinha">
	...
	while($user_data = mysqli_fetch_assoc($result1))
	{
		...
		echo "<a style='cursor:pointer;' title='Copiar resultado para área de expressão' onclick='cp_exp(&#34;(-b+raiz(b^2-4*a*c))/(2*a)&#34;);'> <img src='imagens/Icon/curved-up-arrow.png'> </a>";echo "</td>";
		echo "</tr>";
	}
	?>
